...
###########################################################################
## Class FrameAgregarGasto
###########################################################################

class FrameAgregarGasto ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Agregar un nuevo gasto de campaña", pos = wx.DefaultPosition, size = wx.Size( 388,302 ), style = wx.DEFAULT_DIALOG_STYLE )
