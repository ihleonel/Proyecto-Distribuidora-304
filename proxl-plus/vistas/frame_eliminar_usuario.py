...
class FrameEliminarUsuario ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Eliminar datos de ususario", pos = wx.DefaultPosition, size = wx.Size( 519,330 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.btn_aceptar = wx.Button( self, wx.ID_OK, u"Eliminar", wx.DefaultPosition, wx.Size( 100,30 ), 0 )
