...
###########################################################################
## Class FrameAgregarListado
###########################################################################

class FrameAgregarListado ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Agregar listado", pos = wx.DefaultPosition, size = wx.Size( 678,286 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.tc_comentarios = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 400,80 ), wx.TE_MULTILINE )
		self.tc_comentarios.SetMaxLength( 80 ) 
		...
		self.m_staticText4 = wx.StaticText( self, wx.ID_ANY, u"Archivo:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.tc_archivo = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 400,-1 ), wx.TE_READONLY )
		self.tc_archivo.SetFont( wx.Font( 11, 70, 90, 90, False, wx.EmptyString ) )
		
		gbSizer2.Add( self.tc_archivo, wx.GBPosition( 2, 1 ), wx.GBSpan( 1, 4 ), wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		gbSizer2.Add( self.btn_buscar, wx.GBPosition( 2, 5 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
		...
		gbSizer1.Add( self.btn_aceptar, wx.GBPosition( 1, 4 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
		...
		gbSizer1.Add( self.btn_cancelar, wx.GBPosition( 1, 5 ), wx.GBSpan( 1, 1 ), wx.ALIGN_RIGHT|wx.TOP|wx.BOTTOM|wx.LEFT, 5 )
