...
###########################################################################
## Class FrameVerUsuario
###########################################################################

class FrameVerUsuario ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Ver usuario", pos = wx.DefaultPosition, size = wx.Size( 500,330 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.tc_clave = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 270,-1 ), wx.TE_READONLY )
		...
		self.tc_tipo = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 200,-1 ), wx.TE_READONLY )
		self.tc_tipo.SetFont( wx.Font( 11, 70, 90, 90, False, wx.EmptyString ) )
		
		gbSizer2.Add( self.tc_tipo, wx.GBPosition( 2, 1 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
		...
		gbSizer1.Add( self.btn_visto, wx.GBPosition( 1, 4 ), wx.GBSpan( 1, 1 ), wx.ALIGN_RIGHT|wx.TOP|wx.BOTTOM|wx.LEFT, 5 )
