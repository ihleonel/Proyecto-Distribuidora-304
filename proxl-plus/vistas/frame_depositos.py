...
###########################################################################
## Class FrameDepositos
###########################################################################

class FrameDepositos ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Depositos de campaña", pos = wx.DefaultPosition, size = wx.Size( 702,367 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.grilla = wx.grid.Grid( self, wx.ID_ANY, wx.DefaultPosition, wx.Size( 510,155 ), 0 )
		...
		self.grilla.SetColSize( 1, 140 )
		self.grilla.SetColSize( 2, 140 )
		self.grilla.EnableDragColMove( True )
		self.grilla.EnableDragColSize( True )
		self.grilla.SetColLabelSize( 30 )
		self.grilla.SetColLabelValue( 0, u"Número" )
		self.grilla.SetColLabelValue( 1, u"Fecha" )
		self.grilla.SetColLabelValue( 2, u"Monto" )
