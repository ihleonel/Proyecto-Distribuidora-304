...
###########################################################################
## Class FrameGastosVarios
###########################################################################

class FrameGastosVarios ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Gastos varios de campaña", pos = wx.DefaultPosition, size = wx.Size( 700,367 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.grilla.SetColLabelValue( 1, u"Monto" )
		self.grilla.SetColLabelValue( 2, u"Concepto" )
