...
###########################################################################
## Class FrameDesmanteladoCampania
###########################################################################

class FrameDesmanteladoCampania ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Desmantelado de Campaña", pos = wx.DefaultPosition, size = wx.Size( 945,510 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.st_titulo = wx.StaticText( self, wx.ID_ANY, u"Listado de Desmantelado", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.st_titulo.Wrap( -1 )
		self.st_titulo.SetFont( wx.Font( 11, 70, 90, 90, False, wx.EmptyString ) )
		
		gbSizer1.Add( self.st_titulo, wx.GBPosition( 0, 0 ), wx.GBSpan( 1, 1 ), wx.ALIGN_CENTER_HORIZONTAL|wx.TOP, 20 )
		...
		self.grilla.SetColSize( 1, 50 )
		self.grilla.SetColSize( 2, 280 )
		self.grilla.SetColSize( 3, 80 )
		self.grilla.SetColSize( 4, 200 )
		self.grilla.SetColSize( 5, 80 )
		self.grilla.SetColSize( 6, 80 )
		self.grilla.SetColSize( 7, 170 )
		self.grilla.SetColSize( 8, 170 )
		...
		self.grilla.SetColLabelValue( 1, u"Cant." )
		self.grilla.SetColLabelValue( 2, u"Apellido y nombre" )
		self.grilla.SetColLabelValue( 3, u"Sección" )
		self.grilla.SetColLabelValue( 4, u"Teléfono" )
		self.grilla.SetColLabelValue( 5, u"Camp" )
		self.grilla.SetColLabelValue( 6, u"Deuda" )
		self.grilla.SetColLabelValue( 7, u"Barrio" )
		self.grilla.SetColLabelValue( 8, u"Localidad" )
