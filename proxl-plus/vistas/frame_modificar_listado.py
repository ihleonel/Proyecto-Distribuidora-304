...
###########################################################################
## Class FrameModificarListado
###########################################################################

class FrameModificarListado ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Modificar listado", pos = wx.DefaultPosition, size = wx.Size( 687,265 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.btn_modificar = wx.Button( self, wx.ID_OK, u"Modificar", wx.DefaultPosition, wx.Size( 100,30 ), 0 )
		self.btn_modificar.SetFont( wx.Font( 11, 70, 90, 92, False, wx.EmptyString ) )
		
		gbSizer1.Add( self.btn_modificar, wx.GBPosition( 1, 4 ), wx.GBSpan( 1, 1 ), wx.ALIGN_CENTER_VERTICAL|wx.TOP|wx.BOTTOM|wx.LEFT, 5 )
