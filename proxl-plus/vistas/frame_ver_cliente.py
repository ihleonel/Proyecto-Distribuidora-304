...
###########################################################################
## Class FrameVerCliente
###########################################################################

class FrameVerCliente ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Ver datos de cliente", pos = wx.DefaultPosition, size = wx.Size( 730,494 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.tc_telefonos = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 250,-1 ), wx.TE_READONLY )
		...
		self.tc_seccion = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_CENTRE|wx.TE_READONLY )
		...
		self.tc_zona = wx.TextCtrl( self, wx.ID_ANY, u"403", wx.DefaultPosition, wx.DefaultSize, wx.TE_CENTRE|wx.TE_READONLY )
		...
		self.tc_descripcion = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 500,100 ), wx.TE_MULTILINE|wx.TE_READONLY )
		...
		self.btn_visto = wx.Button( self, wx.ID_CANCEL, u"Visto", wx.DefaultPosition, wx.Size( 100,30 ), 0 )
		self.btn_visto.SetFont( wx.Font( 11, 70, 90, 92, False, wx.EmptyString ) )
		
		gbSizer1.Add( self.btn_visto, wx.GBPosition( 1, 6 ), wx.GBSpan( 1, 1 ), wx.ALIGN_RIGHT|wx.TOP|wx.BOTTOM|wx.LEFT, 5 )
