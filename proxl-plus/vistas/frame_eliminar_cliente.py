...
###########################################################################
## Class FrameEliminarCliente
###########################################################################

class FrameEliminarCliente ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Eliminar datos de cliente", pos = wx.DefaultPosition, size = wx.Size( 730,494 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		gbSizer1.Add( self.btn_eliminar, wx.GBPosition( 1, 5 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.ALIGN_RIGHT, 5 )
