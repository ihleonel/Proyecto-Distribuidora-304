...
###########################################################################
## Class FrameEliminarDeposito
###########################################################################

class FrameEliminarDeposito ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Eliminar datos de deposito", pos = wx.DefaultPosition, size = wx.Size( 400,225 ), style = wx.DEFAULT_DIALOG_STYLE )
