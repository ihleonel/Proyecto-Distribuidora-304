...
class FrameAgregarUsuario ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Agregar ususario", pos = wx.DefaultPosition, size = wx.Size( 519,330 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		sbSizer1 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"Nuevo usuario" ), wx.VERTICAL )
