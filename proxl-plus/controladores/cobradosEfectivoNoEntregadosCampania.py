...
class ControladorCobradosEfectivoNoEntregadosCampania:
	...
	def cargarDatos(self):
		...
		self.titulo = u"Cobrados en efectivo no entregados"
		self.frame.st_titulo.SetLabel(self.titulo)
		self.lista = self.mdlArt.listarCobradosEfectivoNoEntregados()
