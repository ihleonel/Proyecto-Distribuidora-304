# -*- coding: utf-8 -*-
import wx
from vistas.frame_caja_egresos_varios import FrameCajaEgresosVarios

from validadores.validarOpCaja import Monto

from modelos.modelMovimientos import ModeloMovimientos

class ControladorCajaEgresosVarios:
	...
	def run(self):
		self.frame = FrameCajaEgresosVarios(self.parent)
